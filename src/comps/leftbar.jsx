...
export default function LeftBar(){
    return(
        <div className=" h-screen w-[22%] fixed p-2">
          ...
          <button className=" rounded-3xl bg-[#1d9bf0] hover:bg-[#3e96d1] text-white p-2 px-20 font-medium my-3 ">Post</button>
            <div className=" fixed bottom-3 flex items-center content-center rounded-full hover:bg-gray-700 hover:bg-opacity-30 p-2">
            <img src="https://www.strasys.uk/wp-content/uploads/2022/02/Depositphotos_484354208_S.jpg" alt="" className="rounded-full" width={40} height={40}/>
            <div className="pl-1 flex flex-col flex-1 "><h1 className="text-sm font-semibold"> Mahdi</h1><p className="text-gray-400 text-sm">@mansourbmahdi</p></div>
